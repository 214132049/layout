<template>
  <a-tabs :class="{hideHeader:hideHeader}" v-model="editableTabsValue2" closable @tab-remove="removeTab">
    <a-tab-pane v-for="(item, index) in editableTabs2" :label="item.pageName" :name="item.key" :key="item.name">
