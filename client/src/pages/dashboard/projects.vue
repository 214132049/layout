      ...
      <div class="content">
        <div class="top-area">
          <a-tabs class="nav-links" :active-name="activeName" @tab-click="tabHandleClick">
            <a-tab-pane label="我的参与的项目" name="me"></a-tab-pane>
            <!-- <a-tab-pane label="关注项目" name="star"></a-tab-pane>
         -->
          </a-tabs>
        ...
        <div class="projects-list-holder">
          <ul v-if="activeName==='me'" class="projects-list content-list">
            ...
            <a-collapse v-model="activeNames" v-else>
              <a-collapse-item :title="group.name" :name="group.id" v-for="(group, index) in myProjects" :key="group.groupId">
...
<style lang="stylus" rel="stylesheet/stylus" scoped type="text/stylus">
  ...
  .projects-list-holder .a-collapse-item >>> .a-collapse-item__wrap {
    border 0
    overflow auto
  }
  ...
  .content-wrapper .content .projects-list-holder .a-collapse {
    border 0
  }
  .card {
    float: left;
