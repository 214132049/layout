      ...
      <div class="container-fluid">
        <div class="nav-control scrolling-tabs-container">
          <a-tabs class="nav-links" v-model="activeName" @tab-click="tabHandleClick">
            <a-tab-pane label="页面" name="doc"></a-tab-pane>
            <a-tab-pane label="成员" name="member"></a-tab-pane>
            <a-tab-pane v-if="project.role<=1" label="设置" name="setting"></a-tab-pane>
          </a-tabs>
        </div>
        <div class="controls">
          <a-button type="primary" @click="newApi" icon="plus">添加页面</a-button>
        </div>
      </div>
    </div>
        ...
        <div v-else class="content">
          ...
          <div v-if="activeName==='setting'">
            ...
            <div class="panel pana-danger">
              <div class="pana-heading">删除项目</div>
              <div class="pana-body">
                <p>
                  删除项目是不可逆的，确认
                  <br>
