      ...
      <div class="container-fluid">
        <div class="nav-control scrolling-tabs-container">
          <a-tabs class="nav-links" v-model="activeName" @tab-click="tabHandleClick">
            <a-tab-pane v-if="project.role<4" label="设置" name="setting"></a-tab-pane>
            <a-tab-pane  label="操作历史" v-if="project.role<4" name="history"></a-tab-pane>
          </a-tabs>
        </div>
        <div class="controls">
          <a-button type="primary" @click="goPageList">页面列表</a-button>
        </div>
      </div>
    </div>
        ...
        <div v-else class="content">
          ...
          <div v-if="activeName==='setting'">
            ...
            <div class="panel pana-danger">
              <div class="pana-heading">删除页面</div>
              <div class="pana-body">
                <p>
                  删除页面是不可逆的，确认
                  <br>
