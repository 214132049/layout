    ...
    <div class="row prepend-top-default">
      ...
      <div class="col-lg-9">
        ...
        <a-form ref="form" :model="form" laba-width="80px">
          ...
          <a-form-item label="所属组" prop="groupId" :rules="[
            ...
            <a-button type="text" @click="addGroup">添加组</a-button>

          </a-form-item>
          <a-form-item label="项目名称" prop="name" :rules="[
          ...
          <a-form-item label="描述" prop="desc" :rules="[{ required: true,message: '输入描述', trigger: 'blur'},
                                { min: 1, max: 50, message: '长度在 1 到 50 个字符', trigger: 'blur' }]">
            <a-input type="textarea" :maxlength="50" v-model="form.desc"></a-input>
          </a-form-item>
          <!-- <a-form-item label="公开等级">
            <a-radio-group v-model="form.visibilitylevel">
              <a-radio :label="0">私有</a-radio>
              <a-radio :label="1">公开</a-radio>
            </a-radio-group>
          </a-form-item> -->
